...
<body>
    <div class="container mt-5">
        ...
        <div class="row mt-5">
            <div class="col">
                <form action="{{ route('edit_pengajuan', ['pengajuan' => $pengajuan->id]) }}" method="POST" class="d-inline">
                    @method('PUT')
                    @csrf()
                    <div class="row">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-10">
                            <select class="form-select w-auto" name="bidang_kajian" id="bidang_kajian" required>
                                <option selected>Pilih Bidang Kajian</option>
                                <option value="Teknik Informatika" {{ $pengajuan->bidang_kajian == 'Teknik Informatika' ? 'selected' : '' }}>Teknik Informatika</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-4">
