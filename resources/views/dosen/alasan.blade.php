            ...
            <div class="container mt-5">
                ...
                <form action='' method='post'>
                    <div class="my-3 p-3 bg-body rounded shadow-sm">
                        <div class="d-flex">
                            <div class="col-sm-10">
                                <textarea class="form-control" name='detail' id="detail" cols="30" rows="6"></textarea>
                            </div>
                            <div class="d-flex align-items-end ms-3">
                                <a href="{{ route('list_mahasiswa') }}" class="btn btn-primary mb-10 me-1" style="width: 100px">kirim</a>                 
                            </div>
                        </div>  
                    </div>
                </form>
